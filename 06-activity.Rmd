...
- Tables are linked with foreign keys.
- This organization reduces memory demands, but requires a strong knowledge of joins to extract meaningful information.
- [IMBD](https://www.imdb.com/) stores their data about movies in a similar format. 
...
- Feel free to use other functions unless explictly told not to. 
...
3. Create a new object call actors that only contains information about actor-movie pairs where they are categorized as actors. 

4. Are there actors that for whom we don't have their movie history? 
