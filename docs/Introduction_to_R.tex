...
\includegraphics{Introduction_to_R_files/figure-latex/unnamed-chunk-162-1.pdf}
...
\NormalTok{                            intervention_finished }\OperatorTok{==}\StringTok{ }\DecValTok{0} \OperatorTok{~}\StringTok{ }\KeywordTok{sample}\NormalTok{(}\DataTypeTok{size =} \KeywordTok{n}\NormalTok{(), }\KeywordTok{c}\NormalTok{(}\StringTok{"Excellent"}\NormalTok{, }\StringTok{"Good"}\NormalTok{, }\StringTok{"Adequate"}\NormalTok{, }\StringTok{"Poor"}\NormalTok{, }\StringTok{"Terrible"}\NormalTok{), }\DataTypeTok{replace =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{prob =} \KeywordTok{c}\NormalTok{(.}\DecValTok{2}\NormalTok{, }\FloatTok{.2}\NormalTok{, }\FloatTok{.3}\NormalTok{, }\FloatTok{.1}\NormalTok{, }\FloatTok{.2}\NormalTok{))),}
    \DataTypeTok{GPA =} \KeywordTok{if_else}\NormalTok{(session }\OperatorTok{==}\StringTok{ "evening"}\NormalTok{, }\KeywordTok{rnorm}\NormalTok{(}\DecValTok{120}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DataTypeTok{sd =}\NormalTok{.}\DecValTok{75}\NormalTok{), }\KeywordTok{rnorm}\NormalTok{(}\DecValTok{120}\NormalTok{, }\FloatTok{2.3}\NormalTok{, }\FloatTok{.30}\NormalTok{)), }
    \DataTypeTok{SWB =}\NormalTok{(((GPA}\OperatorTok{-}\KeywordTok{mean}\NormalTok{(GPA))}\OperatorTok{/}\KeywordTok{sd}\NormalTok{(GPA)}\OperatorTok{*}\NormalTok{.}\DecValTok{3}\OperatorTok{+}\KeywordTok{rnorm}\NormalTok{(}\DecValTok{120}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DataTypeTok{sd =} \FloatTok{.91}\NormalTok{))}\OperatorTok{+}\FloatTok{2.5}\NormalTok{)}\OperatorTok{*}\FloatTok{1.3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
