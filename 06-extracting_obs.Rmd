...
- Let's use distinct() determine:

<div class = list>
1. How many unique managers do we have?
2. How many unique employees do we have?
3. How many unique manager employee combinations do we have?
</div>
