...
- I merged the survey dataset with the data set below based on the ResponseId variable.
...
## dplyr Functions for Joining and Binding
<div class = activity>
...
2. Instead of rehash the common form, described how each join function handles observations without a match.
...
```{r, fig.width=10, fig.height=4, message=FALSE, echo=FALSE, warning=FALSE}
